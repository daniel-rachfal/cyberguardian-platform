...
class Database
{
    ...
    /**
     * This method executes an SQL statement and returns the number of affected rows. Useful for DELETE and UPDATE operations.
     * 
     * @param  string  $sql     An SQL statement
     * @param  array   $params  An associative array of parameters (default empty array) 
     ...
     */
    public function executeSQLWithRowCount($sql, $params = [])
    {
        try {
            $stmt = $this->dbConnection->prepare($sql);
            $stmt->execute($params);
